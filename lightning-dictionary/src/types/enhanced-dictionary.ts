...
export interface LegacyWordDefinition {
  rank: number;
  pos: string;
  frequency: number;
  definitions: string[];
      ...
      posGroups: [
          ...
          definitions: [
            {
              ...
              examples: ['Students took a test on Friday'],
        ...
        },
        {
          ...
          definitions: [
            {
              id: 'test-verb-0',
              text: 'Take measures to check the quality or performance',
              examples: ['We need to test the new software'],
              synonyms: ['check', 'examine', 'evaluate']
            }
          ]
        }
      ],
